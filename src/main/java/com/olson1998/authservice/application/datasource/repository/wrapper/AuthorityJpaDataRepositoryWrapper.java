...
import com.olson1998.authservice.domain.port.data.repository.AuthorityDataRepository;
import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;

@Service
@RequiredArgsConstructor
public class AuthorityJpaDataRepositoryWrapper implements AuthorityDataRepository {
